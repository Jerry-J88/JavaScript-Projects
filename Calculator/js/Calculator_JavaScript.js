...
const Calculator = {
    //this will display 0 on teh calculator screen
    Display_Value: '0',
    //This will hold the first operand for any expressions, we set it to null for now.
    First_Operand: null,
    //This checks wether or not the second operand has been inputted by the user
    Wait_Second_Operand: false,
    //this sill hold the operator, we set it to null for now.
    operator: null,
};
...
function Input_Digit(digit) {
    ...
    //to the key that was clciked on.
...
function Input_Decimal(dot) {
    //This ensures that accidental clickign of the decimal point doesn't 
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //If operator existsm property lookup is performed for the operator 
        //in the Perfrom_Calculationobject and the function that matches the
